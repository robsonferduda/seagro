...
.noticia-form .note-editor.note-frame { border-radius: 8px; }
</style>
@endsection
...
<div class="col-md-12 noticia-form">
    <div class="nf-hero">
        <div>
            <h3><i class="fa fa-newspaper-o"></i> Nova notícia</h3>
            <p>Preencha os dados e use a Galeria para inserir imagens no texto.</p>
        </div>
                ...
                <div class="nf-panel nf-panel-conteudo">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="subtitulo"
                               placeholder="Linha de apoio exibida abaixo do título" value="{{ old('subtitulo') }}">
